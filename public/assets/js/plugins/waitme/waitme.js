...
class WaitLoad {
  constructor(configs = {}) {
    this.element = (typeof configs.element != 'undefined') ? configs.element : $(`body`);
    this.numeration((typeof configs.num != 'undefined') ? configs.num : 1);
    this.effect = (typeof configs.effect != 'undefined') ? configs.effect : 'bounce';
    this.fontSize = (typeof configs.fontSize != 'undefined') ? configs.fontSize : '28px';
    this.background = (typeof configs.background != 'undefined') ? configs.background : 'rgba(255, 255, 255, 0.7)';
    this.color = (typeof configs.color != 'undefined') ? configs.color : '#1a0e3e';
    this.text = (typeof configs.text != 'undefined') ? configs.text : 'Loading...';
    this.waitTime = (typeof configs.waitTime != 'undefined') ? configs.waitTime : -1;
    this.source = (typeof configs.source != 'undefined') ? configs.source : 'img.svg';
    this.text = (typeof configs.text != 'undefined') ? configs.text : '';
  }
